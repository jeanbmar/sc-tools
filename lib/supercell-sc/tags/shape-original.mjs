...
import ShapeDrawBitmapCommand from './shape-draw-bitmap-command.mjs';
...
class ShapeOriginal extends Tag {
  ...
  decode(smartBuf) {
    ...
    do {
      ...
      switch (tagSignature) {
        ...
        case 17:
        case 22:
          this.shapeDrawBitmapCommands.push(
            ShapeDrawBitmapCommand.decode(smartBuf)
          );
          break;
        case 6:
  ...
  encode(mainBuf) {
    ...
    this.shapeDrawBitmapCommands.forEach((shapeDrawBitmapCommand) =>
      shapeDrawBitmapCommand.encode(smartBuf)
    );
